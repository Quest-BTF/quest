...
const HouseMasterSchema = new mongoose.Schema(
  {
    ...
    hoursPerWeek: {
      type: String,
      required: [true, 'Please specify your hours per week'],
    },
    timezone: {
      type: String,
    ...
    availableDays: {
      type: [String],
      required: [true, 'Please select your available days'],
    },
    councilAnswers: {
      type: Map,
      of: String,
      required: [true, 'Please provide answers to the council questions'],
    },
    decidingAnswer: {
      type: String,
      required: [true, 'Please provide your deciding answer'],
    },
    decidingReason: {
      type: String,
      default: '',
